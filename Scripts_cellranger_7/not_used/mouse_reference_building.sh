...
#############################################################################################################################
# I didn't use this script because I used the pre-built reference refdata-gex-mm10-2020-A.tar.gz 
# It is only necessary to run this script if you want to build a new reference genome

#############################################################################################################################
#############################################################################################################################
## Build mouse reference genome (CellRanger)
