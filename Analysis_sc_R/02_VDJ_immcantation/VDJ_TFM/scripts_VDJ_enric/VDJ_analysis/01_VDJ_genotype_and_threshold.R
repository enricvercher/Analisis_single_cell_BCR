...
#   novel_rows <- NULL
#   ######
#   #CORRECTED BY ENRIC VERCHER. findnovelgenes recognize lowercase "airr format"
#   # NOT WOEK WITH CHANGEO FORMAT, TRY WITH AIRR FORMAT
#   ######
#   # https://immcantation.readthedocs.io/en/stable/datastandards.html
#   # https://tigger.readthedocs.io/en/stable/topics/findNovelAlleles/
#   # https://immcantation.readthedocs.io/en/stable/datastandards.html
...
for (m in mice) {
  ...
  #Change V_CALL_GENOTYPED to V_CALL
  # add sequenceColumn = "JUNCTION" and CallColumn = "J_CALL"
  dist_ham <- distToNearest(seqdb_mouse, sequenceColumn = "JUNCTION", vCallColumn="V_CALL",jCallColumn = "J_CALL", model="ham", normalize="len", nproc=1)
